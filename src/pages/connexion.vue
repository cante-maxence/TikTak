<template>
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-blue-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <img src="https://images.unsplash.com/photo-1522312346375-d1a52e2b99b3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=694&q=80"
                alt="Une montre de luxe sur une couette bleu" class="w-full h-full object-cover">
        </div>
        ...
        flex items-center justify-center">
            ...
            <div class="w-full h-100">
                ...
                <h1 class="text-xl md:text-2xl font-bold leading-tight mt-12">Se connecter ou s'inscrire </h1>
